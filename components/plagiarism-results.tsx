...
export function PlagiarismResults() {
  ...
  const wordCount = 6716
  const sources = [
    {
      id: 4,
      title: "Acceptance and Use of Mobile Technologies in Learning and Teaching of EFL: An Economic Perspective",
      author: "Almarwani, Manal",
      link: "https://riunet.upv.es/bitstream/10251/162323/1/Almarwani%20-%20Acceptance%20and%20Use%20of%20Mobile%20Technologies%20in%20Learning%20and%20Teaching%20of%20EFL%3a%20An%20Economi....pdf",
      score: 0.55,
      semantic: 0.86,
      ngram: 0.003,
      fuzzy: 0.6,
    ...
    {
      id: 1,
      title: "Impact of mobile assisted language learning on learner autonomy in EFL reading context",
      author: "Nasr, H.A., Abbas, A.A.",
      link: "https://cyberleninka.ru/article/n/impact-of-mobile-assisted-language-learning-on-learner-autonomy-in-efl-reading-context",
      score: 0.44,
      semantic: 0.85,
      ngram: 0.0001,
      fuzzy: 0.07,
    },
    {
      ...
      author: "Khudhair, Nisreen Kadhim",
      link: "https://core.ac.uk/download/426977414.pdf",
      score: 0.52,
      semantic: 0.83,
      ngram: 0.0009,
      fuzzy: 0.55,
